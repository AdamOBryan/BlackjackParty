...
// CS 0445 Spring 2016
// Assignment 1
// Card class for BlackJack card game.
public class Card implements Comparable<Card>
{
// These are enum types that make the suits and ranks of the cards more
//readable. They
// are also used for comparison of cards, as shown in equals and compareTo
//below. You
// can access the types themselves using the class
// initialize your deck of cards. 
public static enum Suits {Spades, Clubs, Diamonds, Hearts}
public static enum Ranks {Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten,
Jack, Queen, King, Ace}
private Suits suit;
private Ranks rank;
...
// Blackjack value of a card. 2 through 10 have face value; Jack, Queen and
//King
