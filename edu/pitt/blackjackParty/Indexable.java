...
// If the collection has fewer than (i+1) items, throw an
//IndexOutOfBoundsException
public T get(int i);
// Assign item to logical location i in the implementing collection, where
//location
// 0 is the logical beginning of the collection. If the collection has fewer
//than
